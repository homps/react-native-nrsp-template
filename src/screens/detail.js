...
class DetailsScreen extends React.Component {
    ...
    render() {
      ...
      let lorumText = this.props.lorum ? '<h1>Fetched Lorum</h1>' + this.props.lorum 
      ...
      return (
        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
          ...
          <WebView source={{html: lorumText}} style={{width:deviceWidth, height:30, flex:1}}/>
